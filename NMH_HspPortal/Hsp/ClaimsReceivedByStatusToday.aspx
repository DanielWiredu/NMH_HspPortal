<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ClaimsReceivedByStatusToday.aspx.cs" Inherits="NMH_HspPortal.Hsp.ClaimsReceivedByStatusToday" %>
                ...
                <asp:UpdatePanel runat="server" ID="upProcess">
                    <ContentTemplate>
                        ...
                        <telerik:RadGrid ID="claimsGrid" runat="server" AllowPaging="true" AllowSorting="True" DataSourceID="claimSource" GroupPanelPosition="Top" OnItemCommand="claimsGrid_ItemCommand">
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataSourceID="claimSource" PageSize="50" GroupLoadMode="Server" DataKeyNames="BatchNo">
                                <Columns>
                                    <telerik:GridClientSelectColumn>
                                        <HeaderStyle Width="30px" />
                                    </telerik:GridClientSelectColumn>
                                    <telerik:GridBoundColumn DataField="BatchNo" DataType="System.Int32" FilterControlAltText="Filter BatchNo column" HeaderText="Batch No" SortExpression="BatchNo" UniqueName="BatchNo">
                                   ...
                                   <%-- <telerik:GridButtonColumn Text="Delete" CommandName="Delete" UniqueName="Delete" ConfirmText="Delete this Company Plan and all associated Benefits?" ButtonType="PushButton" ButtonCssClass="btn-danger" Exportable="false">
                                        ...
                                        <asp:SqlDataSource ID="claimSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="spGetClaimsByStatus_Today" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
