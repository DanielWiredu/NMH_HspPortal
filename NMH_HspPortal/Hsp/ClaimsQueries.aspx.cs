...
{
    public partial class ClaimsQueries : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("/HSP/ClaimsReceived.aspx?pid=" + ViewState["pid"].ToString() + "&pname=" + ViewState["pname"].ToString());
        }
    }
}