...
{
    public partial class ClaimsReceivedByStatus : System.Web.UI.Page
    {
        ...
        protected void claimsGrid_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Queries")
            {
                ...
                Response.Redirect("/Hsp/ClaimsQueriesByStatus.aspx?adviceBatchNo=" + item["ID"].Text + "&pname=" + item["ServiceProvider"].Text + "&batchStatusId=" + ViewState["batchStatusId"].ToString());
            }
        }
